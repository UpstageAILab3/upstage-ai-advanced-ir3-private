...
model = SentenceTransformer("Alibaba-NLP/gte-Qwen2-1.5B-instruct").cuda()
...
es_username = "elastic"
es_password = "u0jyO6oR13M2kJD_L=MS"
...
test_query = "Venus appear brighter than the other planets?"
...
persona_qa = """
## Role: Science common sense expert

## Instructions
- Generate a concise answer using the user's previous message information and the given reference information.
- If the given search result information does not allow an answer, answer that there is insufficient information to answer.
- Generate an answer in Korean.
"""

# RAG 구현에 필요한 질의 분석 및 검색 이외의 일반 질의 대응을 위한 LLM 프롬프트
persona_function_calling = """
- You should be able to call the search API when a user asks a question about a scientific knowledge topic through a conversation.
- Generates appropriate replies to the remaining conversation messages that are not related to scientific common sense.
"""
...
eval_rag("../data/translated_eval.jsonl", "sample_submission2.csv")
